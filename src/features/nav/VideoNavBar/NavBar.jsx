...
class NavBar extends Component {
  ...
  render() {
    const overlay = <div id="sidenav-overlay" style={{backgroundColor: 'white'}} onClick={this.handleNavbarClick}/>
    ...
    return (
      ...
      <div id="videobackground">
        ...
        <div>
          <Navbar dark expand="md"  inverted scrolling>
            <Container>
              <NavbarBrand>
              ...
              <Collapse isOpen = {this.state.collapse} navbar>
                <NavbarNav left>
                  ...
                  <NavItem>
                    <NavLink to="/events">Features</NavLink>
                  </NavItem>
                  <NavItem>
